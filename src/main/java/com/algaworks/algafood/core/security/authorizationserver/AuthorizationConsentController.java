...
public class AuthorizationConsentController {
	...
	public String consent(
		...
		Set<String> scopesAprovados;
		if (consent != null) {
			scopesAprovados = consent.getScopes();
			scopesParaAprovar.removeAll(scopesAprovados);
		} else {
			scopesAprovados = Collections.emptySet();
		}
		...
		model.addAttribute("scopesAprovados", scopesAprovados);
