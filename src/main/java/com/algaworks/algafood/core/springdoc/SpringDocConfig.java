...
public class SpringDocConfig {
	...
	private static final String MSG_REQUISICAO_INVALIDA = "Requisição inválida";
	private static final String MSG_RECURSO_NAO_ENCONTRADO = "Recurso não encontrado";
	private static final String MSG_RECURSO_NAO_ACEITO = "Recurso não possui representação que poderia ser aceita pelo consumidor";
