...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, 
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s' que é de "
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		String detail = String.format("Não existe o recurso '%s' que você tentou acessar.", ex.getRequestURL());
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex,
		...
		String detail = String.format("A propriedade '%s' recebeu o valor '%s' que é um "
