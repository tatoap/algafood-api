...
public class RestauranteInputDisassembler {
	...
	// Metodo criado somente para fazer a conversão Model/Object para a o método atualizar parcial
	public RestauranteInput toModelObject(Restaurante restaurante) {
