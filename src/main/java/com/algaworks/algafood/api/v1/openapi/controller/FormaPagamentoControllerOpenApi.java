...
public interface FormaPagamentoControllerOpenApi {
	...
	FormaPagamentoModel adicionar(
			@Parameter(description = "Representação de uma nova forma de pagamento", required = true) 
	...
	FormaPagamentoModel atualizar(
			...
			@Parameter(description = "Representação de uma forma de pagamento atualizada", required = true) 
				FormaPagamentoInput formaPagamentoInput);
