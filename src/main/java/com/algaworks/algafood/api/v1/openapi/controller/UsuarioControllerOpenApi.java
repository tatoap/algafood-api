...
public interface UsuarioControllerOpenApi {
	...
	UsuarioModel adicionar(
		@Parameter(description = "Representação de um novo usuário", required = true)
	...
	UsuarioModel atualizar(
		@Parameter(description = "Id do usuário", example = "1", required = true)
			Long usuarioId, 
		@Parameter(description = "Representação de um usuário com os novos dados", required = true)
